...
class SailFaceCommandBuilder:
    def _add_waypoint_to_buffer(self, buff, buff_offset : int, waypoint_details : Waypoint):
        ...
        waypoint_struct.pack_into(buff, buff_offset, long_lat, long_long, waypoint_details.allowed_radius)

        return buff_offset + waypoint_struct.calcsize()

    def _add_command_message_to_buffer(self, buffer, command_details : SailFaceCommand):
    ...
    def build_command(self):
        ...
        _add_waypoint_to_buffer
    #    
    #    return command_struct.pack(latitude, longitude, allowed_radius)
